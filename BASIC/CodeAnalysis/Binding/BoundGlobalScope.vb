...
Namespace Basic.CodeAnalysis.Binding
  Friend NotInheritable Class BoundGlobalScope
    ...
    Public Sub New(previous As BoundGlobalScope, diagnostics As ImmutableArray(Of Diagnostic), functions As ImmutableArray(Of FunctionSymbol), variables As ImmutableArray(Of VariableSymbol), statements As ImmutableArray(Of BoundStatement))
