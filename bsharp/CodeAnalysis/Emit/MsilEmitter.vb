...
Namespace Bsharp.CodeAnalysis.Emit
  ...
  ' This emitter is designed to handle MSIL.

  Friend NotInheritable Class MsilEmitter
    ...
    Public Shared Function Emit(program As BoundProgram, moduleName As String, references() As String, outputPath As String) As ImmutableArray(Of Diagnostic)
      ...
      Dim emitter = New MsilEmitter(moduleName, references)
    ...
    Private Sub EmitFunctionBody(func As FunctionSymbol, body As BoundBlockStatement)
      ...
      For Each fixup In _fixups
        ...
        If _labels.ContainsKey(targetLabel) Then
    ...
    Private Shared Sub EmitConstantExpression(ilProcessor As ILProcessor, node As BoundExpression)
