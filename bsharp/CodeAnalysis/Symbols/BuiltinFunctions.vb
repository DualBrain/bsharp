...
Namespace Bsharp.CodeAnalysis.Symbols
  ...
  Friend Module BuiltinFunctions
    ...
    Public ReadOnly Abs As New FunctionSymbol("abs", ImmutableArray.Create(New ParameterSymbol("value", TypeSymbol.Any, 0)), TypeSymbol.Double)
    Public ReadOnly Atn As New FunctionSymbol("atn", ImmutableArray.Create(New ParameterSymbol("value", TypeSymbol.Any, 0)), TypeSymbol.Double)
    ...
    Public ReadOnly Rnd As New FunctionSymbol("rnd", ImmutableArray.Create(New ParameterSymbol("max", TypeSymbol.Long, 0)), TypeSymbol.Long)
    ...
    Public ReadOnly Space As New FunctionSymbol("space$", ImmutableArray.Create(New ParameterSymbol("num", TypeSymbol.Any)), TypeSymbol.String)
    Public ReadOnly Str As New FunctionSymbol("str$", ImmutableArray.Create(New ParameterSymbol("num", TypeSymbol.Any)), TypeSymbol.String)
